        <aside class="sidebar-wrapper" data-simplebar="true">
          ...
          <ul class="metismenu" id="menu">
            ...
            <li>
              ...
              <ul>
                <li> <a href="ecommerce-products-list.html"><i class="bi bi-circle"></i>Campaigns </a>
                </li>
                <li> <a href="ecommerce-products-grid.html"><i class="bi bi-circle"></i>Coupons </a>
                </li>
                <li> <a href="ecommerce-products-categories.html"><i class="bi bi-circle"></i>Gift Cards</a>
                </li>
                <li> <a href="ecommerce-orders.html"><i class="bi bi-circle"></i>Loyalty Program</a>
                </li>
              </ul>
            </li>
            <li>
              ...
              <ul>
                <li> <a href="ecommerce-products-list.html"><i class="bi bi-circle"></i>Sales Analytics </a>
                </li>
                <li> <a href="ecommerce-products-grid.html"><i class="bi bi-circle"></i>Customer Analytics</a>
                </li>
                <li> <a href="ecommerce-products-categories.html"><i class="bi bi-circle"></i>Product Analytics</a>
                </li>
                <li> <a href="ecommerce-orders.html"><i class="bi bi-circle"></i>Reports</a>
                </li>
              </ul>
            </li>
